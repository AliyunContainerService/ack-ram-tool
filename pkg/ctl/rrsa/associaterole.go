...
func setupAssociateRoleCmd(rootCmd *cobra.Command) {
	...
	associateRoleCmd.MarkFlagRequired("cluster-id")
	associateRoleCmd.MarkFlagRequired("role-name")
	associateRoleCmd.MarkFlagRequired("namespace")
	associateRoleCmd.MarkFlagRequired("service-account")
}
