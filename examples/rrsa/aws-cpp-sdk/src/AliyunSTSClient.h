...
namespace Aws
{
    ...
    namespace Internal
    {
        ...
        public:
             ...
             */
            AliyunSTSCredentialsClient(const Client::ClientConfiguration& clientConfiguration);
            ...
            // If you want to make an AssumeRoleWithWebIdentity call to sts. use these classes to pass data to and get info from AliyunSTSCredentialsClient client.
